    ...
    <Box>
      <Container maxW={1400}>
        ...
        <Flex my={"10"} gap={"10"} flexDir={{lg:"row", base: "column"}}>
          <Box>
            <Center>
              <Image borderRadius={"full"} width="90" height={"90"} src="/avatar/Zia_Khan.jpg"></Image>
            </Center>
          ...
          <Box>
            <Center>
              <Image borderRadius={"full"} width="90" height={"90"} src="/avatar/Zeeshan_Hanif.jpg"></Image>
            </Center>
          ...
          <Box>
            <Center>
              <Image borderRadius={"full"} width="90" height={"90"} src="/avatar/Daniyal_Nagori.jpg"></Image>
            </Center>
          ...
          <Box>
            <Center>
              <Image borderRadius={"full"} width="90" height={"90"} src="/avatar/Adil_Altaf.jpg"></Image>
            </Center>
          ...
          <Box>
            <Center>
              <Image borderRadius={"full"} width="90" height={"90"} src="/avatar/Hira_khan.jpg"></Image>
            </Center>
